...
if [ $scale != 1 ];  then
    ...
    ncatted -h -O -a scale_factor,${var},c,f,${scale_factor} -a _FillValue,${var},c,s,${newmissing2} -a missing_value,${var},c,s,$((${newmissing2})) ${PROC_DIR}/${file}
else
    ncap2 -h -O --fl_fmt=netcdf4 -s "${var}=short(${var})" ${SRC_DIR}/${file} ${PROC_DIR}/${file}
fi  
